...
setwd("F:/5.6TH SEMESTER/MAT 4601 Probability and Statistics/Assignment1")
getwd()
# Verify if the file exists
file.exists("United_Airlines_Aircraft_Operating_Statistics_Cost_Per_Block_Hour_(Unadjusted)")
# If the file extension is .xls, use:
data_file <- "F:/5.6TH SEMESTER/MAT 4601 Probability and Statistics/Assignment1/United_Airlines_Aircraft_Operating_Statistics_Cost_Per_Block_Hour_(Unadjusted).xls"
...
# View the sample of 23 observations
...
# If you want to take exactly 23 samples, you can sample from combined data
set.seed(123)  # For reproducibility
